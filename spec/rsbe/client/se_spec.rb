describe Rsbe::Client::Se do
  ...
  describe ".new" do
    context "with valid attributes and symbol keys" do
      ...
      its(:title)   { should eq 'Lord Elrond' }
